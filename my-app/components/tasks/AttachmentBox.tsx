export const AttachmentBox = ({ hasAttachment }: { hasAttachment: boolean }) => (
  <div className="w-full h-[72px] rounded-lg border-[1.5px] border-dashed border-gray-300 bg-gray-50 flex flex-col items-center justify-center gap-1 text-gray-500 text-[11px] cursor-pointer mt-1.5">
    {hasAttachment ? (
